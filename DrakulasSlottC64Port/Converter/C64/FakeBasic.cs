...
namespace MarcusMedinaPro.Converter.C64
{
    ...
    public static class FakeBasic
    {
        ...
        const string PetschiiA = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[£]↑←─♠│──▔─││╮╰╯└╲╱┌┐●▁♥▏╭╳○♣▕♦┼▌│π◥";
        const string PetschiiB = " ▌▄▔▁▏▒▕▄◤▄├▗└┐▂┌┴┬┤▎▍▐▔▀▃▟▖▝┘▘π";
        ...
        {
            return (string)Datacollection.Dequeue();
        }
        public static int ReadInt()
        {
            return (int)Datacollection.Dequeue();
        }
        ...
        public static void BackColor(C64Colors color)
        {
            Console.BackgroundColor = color.ToColorfulColor();
        }
        public static void FontColor(C64Colors color)
        {
            Console.ForegroundColor = color.ToColorfulColor();
        }
        ...
        public static void Print(string output = "", bool Newline = true)
        {
            foreach (var ch in output)
            {
                ...
                else if (petsciiCode == 3) Stop();
                else if (petsciiCode == 5) FontColor(C64Colors.White);
                else if (petsciiCode == 17) PosY++;
                else if (petsciiCode == 18) Reverse = true;
                else if (petsciiCode == 19) { PosX = 0; PosY = 0; }
                else if (petsciiCode == 28) FontColor(C64Colors.Red);
                else if (petsciiCode == 29) PosX++;
                else if (petsciiCode == 30) FontColor(C64Colors.Green);
                else if (petsciiCode == 31) FontColor(C64Colors.Blue);
                else if (petsciiCode == 129) FontColor(C64Colors.Orange);
                else if (petsciiCode == 141) { PosY++; PosX = 0; } // Shift return
                else if (petsciiCode == 144) FontColor(C64Colors.Black);
                else if (petsciiCode == 145) PosY--;
                else if (petsciiCode == 146) Reverse = false;
                else if (petsciiCode == 147) ClearScreen();
                else if (petsciiCode == 148) Insert();
                else if (petsciiCode == 149) FontColor(C64Colors.Brown);
                else if (petsciiCode == 150) FontColor(C64Colors.LightRed); //pink
                else if (petsciiCode == 151) FontColor(C64Colors.DarkGrey);
                else if (petsciiCode == 152) FontColor(C64Colors.Grey2);
                else if (petsciiCode == 153) FontColor(C64Colors.LightGreen);
                else if (petsciiCode == 154) FontColor(C64Colors.LightBlue);
                else if (petsciiCode == 155) FontColor(C64Colors.LightGrey);
                else if (petsciiCode == 156) FontColor(C64Colors.Red); //purple
                else if (petsciiCode == 157) PosX++;
                else if (petsciiCode == 158) FontColor(C64Colors.Yellow);
                else if (petsciiCode == 159) FontColor(C64Colors.Cyan);
        ...
        {
            Debug.WriteLine("CHR$(148) function not coded yet");
            // TODO: Create functionality for CHR$(148)
        }
